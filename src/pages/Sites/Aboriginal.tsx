    ...
    return (
        <div className="overflow-auto">
            <div className="relative w-full h-full overflow-hidden rounded-b shadow">
                <video
                    src="https://pub-61be2e1134b34ab087b28b1b2f3f2054.r2.dev/Aboriginal_B-Roll.mp4"
                    autoPlay
                    muted
                    loop
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-y-4">
                    ...
                    <h2 className="text-white font-[200] font-newsreader sm:text-lg drop-shadow-lg text-center px-4">
                        “The art that the Aboriginal tribes of Taiwan had invoked a feeling of strong pride for their culture.”
                        <footer className="mt-2 text-right text-sm not-italic text-white">— Kaven Lin, 2025</footer>
                    </h2>
                </div>
            ...
            <div className="py-12 sm:mx-60" id="content">
                    ...
                    <div className="mb-6">
                        ...
                        <div>
                            <p className="sm:text-lg text-justify">
                                The Shung Ye Museum of Formosan Aborigines (also known as the Aboriginal Museum) is the first private museum that showcases the aborigines' rich culture and history
                                <Footnote number={1} href="https://museums.moc.gov.tw/EN/MusData/Detail?museumsId=9dc3aec6-d8e3-4a44-9054-6e2881236465" tooltip="Source: 文化部-博物之島, 2025."/>
                                .
                            ...
                            <p className="sm:text-lg text-justify">
                                ...
                                and touch different vases and
                                {' '}
                                <WordHover label="tools" src="/aboriginal/tools.JPG" />
                                . Several of their displays of instruments and tools that they used for their rituals and festivals were intentionally interactive,
                                which we think is to intrigue as many people as possible.
                            </p>
                            <figure className="w-[47%] float-right ml-15 pt-10">
                                <img
                                    src="/aboriginal/instruments.jpg"
                                    alt="Playing the Wooden Xylophone"
                                    className="w-full h-auto object-cover rounded mb-2"
                                />
                                <figcaption className="text-sm text-center text-gray-600">
                                    Playing the Wooden Xylophone, Photographed April 9
                                </figcaption>
                            </figure>
                            <br/>
                            <p className="sm:text-lg text-justify">
                                Moving up two floors, the next exhibit that caught our eyes was an
                                {' '}
                                <WordHover label="AR map" src="https://pub-61be2e1134b34ab087b28b1b2f3f2054.r2.dev/ar.mp4" />
                                {' '}
                                of one of their meeting halls.
                            ...
                            <p className="sm:text-lg text-justify">
                                ...
                                The weaving for baskets and belts was different from their
                                {' '}
                                <WordHover label="clothing" src="/aboriginal/traditional.jpg" />
                                {' '}
                                and decoration.
                            ...
                            <figure className="w-[50%] float-left mt-8 mr-10">
                                <img
                                    src="/aboriginal/ar.jpg"
                                    alt="AR Map"
                                    className="w-full h-auto object-cover rounded mb-2"
                                />
                                <figcaption className="text-sm text-center text-gray-600">
                                    AR Map, Photographed April 9
                                </figcaption>
                            </figure>
                            <br/>
                            <p className="sm:text-lg text-justify">
                                ...
                                <Footnote number={2} href="https://taiwanpasiwalifestival.com/en/home/" tooltip="Source: Taiwan PASIWALI Festival 原住民族國際音樂節, 2023."/>
                                .
                            </p>
                            <blockquote className="sm:w-[45%] float-right border-l-4 border-gray-300 pl-4 mt-12 italic text-gray-700 text-lg">
                                “The art that the Aboriginal tribes of Taiwan had invoked a feeling of strong pride for their culture.”
                                <footer className="mt-2 text-right text-sm not-italic text-gray-500">— Kaven Lin, 2025</footer>
                            </blockquote>
                        </div>
                    </div>
                </div>
                <div className="sm:text-lg text-end p-0 m-0">
                    <span
                        onClick={() => window.open('https://maps.app.goo.gl/Zh1MS7wihZwoR3XdA', '_blank')}
                        className="text-blue-500 underline cursor-pointer">No. 282, Sec 2, Zhi Shan Rd, Shilin District, Taipei City, 111
                    </span>
                </div>
                <div>
                    <h1 className="text-6xl text-center mb-6 px-10 pb-10 border-b-1 border-gray-200">Gallery</h1>
                    <div className="flex flex-wrap justify-center gap-x-4 gap-y-4">
                        <ImageModal src="/aboriginal/front.jpg" alt="Front of Shung Ye Museum of Formosan Aborigines" label="Front of Shung Ye Museum of Formosan Aborigines"/>
                        <ImageModal src="/soka/instruments.jpg" alt="Playing the Wooden Xylophone" label="Playing the Wooden Xylophone"/>
                        <ImageModal src="/soka/ar.jpg" alt="AR Map" label="AR Map"/>
                        <ImageModal src="/soka/tools.JPG" alt="Aboriginal Tools" label="Aboriginal Tools"/>
                        <ImageModal src="/shilin/traditional.jpg" alt="Aboriginal clothing" label="Aboriginal clothing"/>
                    </div>
                </div>
            </div>
        </div>
