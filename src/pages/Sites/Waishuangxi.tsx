                ...
                <div className="flex flex-col md:flex-row gap-x-48">
                    <Card className="w-124 h-fit place-self-center">
                        <CardHeader floated={false} className="h-84">
                            <img src="/waishuangxi-map.jpg" alt="profile-picture" className="h-full w-full object-cover"/>
                        </CardHeader>
                    ...
                    <Card className="w-124 h-fit place-self-center">
                        <CardHeader floated={false} className="h-84">
                            <img src="/waishuangxi.jpg" alt="profile-picture" className="h-full w-full object-cover"/>
                        </CardHeader>
                        <CardBody className="text-center py-2">
                            <Typography variant="h4" color="blue-gray" className="mb-2">
                                Dr. Mi Chienkuo
