    ...
    return (
        <div className="flex flex-col md:flex-row justify-center gap-12">
            ...
            <div className="w-72 h-fit place-self-center">
                <img src="/drgrant.png" alt="profile-picture" className="h-70 w-full object-cover"/>
            ...
            <div className="w-72 h-fit place-self-center">
                <img src="/drphil.png" alt="profile-picture" className="h-70 w-full object-cover"/>
                <div className="bg-white text-center py-2 shadow-md">
                    <p className="mb-2">
                        Dr. Philip Hultquist
                    </p>
            ...
            <div className="w-72 h-fit place-self-center">
                <img src="/drdu.jpg" alt="profile-picture" className="h-70 w-full object-cover"/>
                <div className="bg-white text-center py-2 shadow-md">
                    <p className="mb-2">
                        Dr. Wen-Hua Du
                    </p>
